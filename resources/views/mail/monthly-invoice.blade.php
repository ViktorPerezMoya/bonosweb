...
<head>
    ...
    <title>Factura Mensual – BonosWeb</title>
</head>
        ...
        <tr>
            <td align="center">
                <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px; width:100%;">
                    ...
                    {{-- Header --}}
                    <tr>
                        <td style="background: linear-gradient(135deg, #1e3a5f 0%, #1e40af 100%); border-radius: 16px 16px 0 0; padding: 36px 40px; text-align:center;">
                            <p style="margin:0 0 8px 0; font-size:13px; color:#93c5fd; letter-spacing:2px; text-transform:uppercase; font-weight:600;">BonosWeb</p>
                            <h1 style="margin:0; font-size:26px; font-weight:700; color:#ffffff;">Factura Mensual</h1>
                            <p style="margin:8px 0 0 0; font-size:16px; color:#bfdbfe;">
                                @php
                    ...
                    <tr>
                        <td style="background-color:#1e293b; padding: 36px 40px;">
                            ...
                            <p style="margin:0 0 32px 0; font-size:15px; color:#94a3b8; line-height:1.6;">
                                Le informamos que se ha generado su factura mensual por el uso del servicio <strong style="color:#f1f5f9;">BonosWeb</strong>.
                            </p>
                                ...
                                <tr>
                                    <td style="padding:24px 28px;">
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td style="padding: 10px 0; border-bottom:1px solid #1e293b;">
                                                    <span style="color:#64748b; font-size:13px; text-transform:uppercase; letter-spacing:1px;">Monto del Período</span>
                                                </td>
                                                <td style="padding: 10px 0; border-bottom:1px solid #1e293b; text-align:right;">
                                            ...
                                            <tr>
                                                <td style="padding: 14px 0 4px 0;">
                                                    <span style="color:#64748b; font-size:13px; text-transform:uppercase; letter-spacing:1px;">Saldo Corriente Total</span>
                                                </td>
                                                <td style="padding: 14px 0 4px 0; text-align:right;">
                                                    <span style="color:#f87171; font-size:20px; font-weight:700;">$ {{ number_format($tenant->current_balance, 2, ',', '.') }}</span>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                            ...
                            <p style="margin:0 0 20px 0; font-size:14px; color:#94a3b8; line-height:1.6;">
                                Para cancelar su saldo, inicie sesión en la plataforma y utilice la opción <strong style="color:#f1f5f9;">«Informar un Pago»</strong> adjuntando su comprobante de transferencia. El equipo de BonosWeb verificará y aprobará el pago en el menor tiempo posible.
                            </p>

                            <p style="margin:0; font-size:13px; color:#64748b; line-height:1.6;">
                                Si ya realizó el pago o tiene alguna consulta, por favor contáctenos respondiendo este correo.
                            </p>
                        </td>
                    </tr>
