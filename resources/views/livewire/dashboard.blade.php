<div>
    @if(app(\App\Services\CompanyContextService::class)->hasValidContext())
        {{-- ── Stats Cards ── --}}
    ...
    @else
        {{-- ── Empty State ── --}}
        <div class="glass-panel flex flex-col items-center justify-center text-center p-12 mt-10">
            <div class="flex items-center justify-center w-20 h-20 rounded-full mb-6" style="background: rgba(239, 68, 68, 0.1);">
                <i class="ri-shield-keyhole-line text-5xl" style="color: var(--danger);"></i>
            </div>
            <h2 class="text-2xl font-bold mb-3">Sin empresas asignadas</h2>
            <p class="text-muted max-w-md mx-auto mb-6">
                Tu usuario no tiene permisos para operar en ninguna sucursal. Por favor, contacta al Administrador Global para que te asigne una empresa.
            </p>
        </div>
    @endif
</div>
